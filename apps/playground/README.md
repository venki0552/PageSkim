# AgentPage Playground (placeholder)

The playground arrives in **Phase 4**: a Next.js (App Router) app deployable to the Vercel free tier that imports `@agentpage/core` directly, featuring:
...
- The hero **token-savings counter** (raw HTML → AgentPage → header-only, with $ estimates)
